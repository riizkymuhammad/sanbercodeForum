...
<section class="section">
    ...
    <div class="section-body">
        ...
        <p class="section-lead">Masukkan pertanyaan secara ringkas dan jelas.</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label>Judul</label>
                                <input name="title" type="text" class="form-control" placeholder="Masukkan judul pertanyaan">
                            </div>
                            <div class="form-group">
